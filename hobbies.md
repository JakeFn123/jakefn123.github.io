...
<div class="blk-v2">
  <div class="sh-v2">Beyond the Lab</div>
  <p style="color:#3d5060;line-height:1.75;max-width:680px;">The parts of life that shape how I think and work — not just what appears on a resume.</p>
</div>
...
<div class="blk-v2">
  <div class="sh-v2">Background</div>
  <div class="facts-tbl">
    <div class="ft-row"><span class="ft-k">Born</span><span class="ft-v">1998, China</span></div>
    <div class="ft-row"><span class="ft-k">Studied in</span><span class="ft-v">West Lafayette, IN · New York, NY · Shanghai</span></div>
    <div class="ft-row"><span class="ft-k">Languages</span><span class="ft-v">Chinese (native) · English (fluent)</span></div>
    <div class="ft-row"><span class="ft-k">Currently</span><span class="ft-v">Shanghai, China</span></div>
  </div>
</div>
